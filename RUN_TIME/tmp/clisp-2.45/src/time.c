...
#if (!(defined(HAVE_GETRUSAGE))) && (defined(HAVE_SYS_TIMES_H))
}
#endif
#if (!(defined(HAVE_GETRUSAGE))) && (defined(HAVE_SYS_TIMES_H))
}
...
#if defined(TIME_WIN32)
}
#endif
#if defined(TIME_UNIX)
}
#endif
#if !defined(HAVE_RUN_TIME)
}
#endif
#line 283
}
...
#if (defined(TIME_UNIX)) && (!(defined(intQsize)))
}
#endif
#if (defined(TIME_UNIX)) && (!(defined(intQsize)))
}
...
#if (!(TIME_METHOD == 1)) && (TIME_METHOD == 2)
}
#endif
#line 317
}
...
{ GCTRIGGER(); { /* (ENCODE-UNIVERSAL-TIME seconds minutes hours day month year): */
...
/* UP: convert the system (win32) time format into lisp universal time.
 ...
 < result: integer denoting the seconds since 1900-01-01 00:00 GMT
 can trigger GC */
global maygc object convert_time_to_universal (const FILETIME* time) { GCTRIGGER(); {
...
#if (!(TIME_METHOD == 1)) && (TIME_METHOD == 2) && (defined(TIME_WIN32))
}
#endif
#if (!(TIME_METHOD == 1)) && (TIME_METHOD == 2) && (defined(TIME_WIN32))
}
...
#endif
#if (!(TIME_METHOD == 1)) && (TIME_METHOD == 2) && (defined(TIME_UNIX))
}
#endif
#if (!(TIME_METHOD == 1)) && (TIME_METHOD == 2) && (defined(TIME_UNIX))
}
...
{ GCTRIGGER(); { return get_start_time() + real_time_sec(); }}
#endif
#ifdef TIME_ABSOLUTE
