...
/* check_structure_replacement(obj)
 ...
 can trigger GC */
global maygc object check_structure_replacement (object obj) { GCTRIGGER1(obj); {
  do {
...
/* return the address of the Nth constant
 ...
 can trigger GC */
local maygc gcv_object_t* closure_const (void) { GCTRIGGER(); {
...
/* make_code_vector(list) converts a list of fixnums >=0, <256
 ...
 as bytes. */
local maygc void make_code_vector (gcv_object_t *code) { GCTRIGGER(); {
...
/* check_genericlambda_function(obj)
 ...
 can trigger GC */
local maygc object check_genericlambda_function_replacement (object obj) { GCTRIGGER1(obj); {
  do {
    pushSTACK(NIL); /* no PLACE */
    pushSTACK(obj); /* TYPE-ERROR slot DATUM */
...
local inline maygc object check_genericlambda_function (object obj) { GCTRIGGER1(obj); {
...
/* UP: check that the argument is a macro
 ...
 < mac: same
 can trigger GC */
local maygc object check_macro (object obj) { GCTRIGGER1(obj); {
  while (!macrop(obj)) {
    pushSTACK(NIL);             /* no PLACE */
    pushSTACK(obj);             /* TYPE-ERROR slot DATUM */
...
/* ensure that the OBJ is a FUNCTION-MACRO and return it
 can trigger GC */
local maygc object check_function_macro (object obj) { GCTRIGGER1(obj); {
...
/* returns (CLOS:CLASS-OF object). Especially efficient for CLOS objects.
 can trigger GC */
local inline maygc object class_of (object obj) { GCTRIGGER1(obj); {
  if (instancep(obj)) {
...
/* update_instance(obj)
 ...
 can trigger GC */
global maygc object update_instance (object user_obj, object obj) { GCTRIGGER2(user_obj,obj); {
