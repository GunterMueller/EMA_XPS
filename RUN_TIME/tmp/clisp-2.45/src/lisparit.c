...
/* UP: multiplies an integer with 10 and adds a second digit.
 ...
 can trigger GC */
global maygc object mult_10_plus_x (object y, uintB x) { GCTRIGGER1(y); {
  SAVE_NUM_STACK
  var uintD* MSDptr;
  {var uintC len;
  {var uintD* LSDptr;
...
global maygc object read_integer (uintWL base, signean sign, object string,
                                  uintL index1, uintL index2) { GCTRIGGER1(string); {
...
global maygc object read_rational (uintWL base, signean sign, object string,
                                   uintL index1, uintL index3, uintL index2) { GCTRIGGER1(string); {
...
global maygc object read_float (uintWL base, signean sign, object string,
                                ...
                                uintL index3) { GCTRIGGER1(string); {
  pushSTACK(string); /* save string */
  /* exponent: */
...
/* UP: prints a float.
 ...
 < stream: stream
 can trigger GC */
global maygc void print_float (object z, const gcv_object_t* stream_) { GCTRIGGER1(z); {
...
static inline maygc object check_number (object obj) { GCTRIGGER1(obj); {
  if (!numberp(obj))
...
/* check_number_replacement(obj)
 ...
 can trigger GC */
local maygc object check_number_replacement (object obj) { GCTRIGGER1(obj); {
  do {
...
/* check_real_replacement(obj)
 ...
 can trigger GC */
global maygc object check_real_replacement (object obj) { GCTRIGGER1(obj); {
  for (;;) {
    pushSTACK(NIL); /* no PLACE */
    pushSTACK(obj);     /* TYPE-ERROR slot DATUM */
...
static inline maygc object check_float (object obj) { GCTRIGGER1(obj); {
  if (!floatp(obj))
...
/* check_float_replacement(obj)
 ...
 can trigger GC */
local maygc object check_float_replacement (object obj) { GCTRIGGER1(obj); {
  do {
    pushSTACK(NIL); /* no PLACE */
    pushSTACK(obj);      /* TYPE-ERROR slot DATUM */
...
static inline maygc object check_rational (object obj) { GCTRIGGER1(obj); {
...
/* check_rational_replacement(obj)
 ...
 can trigger GC */
local maygc object check_rational_replacement (object obj) { GCTRIGGER1(obj); {
  for (;;) {
    pushSTACK(NIL); /* no PLACE */
    pushSTACK(obj);     /* TYPE-ERROR slot DATUM */
...
/* UP: Returns the decimal string representation of an integer >= 0.
 ...
 can trigger GC */
global maygc object decimal_string (object x) { GCTRIGGER1(x); {
  SAVE_NUM_STACK
  var uintD* MSDptr;
  {var uintC len;
...
local maygc void test_number_args (uintC argcount, gcv_object_t* args_pointer) { GCTRIGGER(); {
  do {
...
/* UP: tests, if all argcount+1 arguments below args_pointer
 ...
 > argcount: number of arguments-1
 > args_pointer: pointer to the arguments */
local maygc void test_real_args (uintC argcount, gcv_object_t* args_pointer) { GCTRIGGER(); {
  do {
    {var gcv_object_t* argptr = &NEXT(args_pointer);
    {var object arg = *argptr; /* next argument */
...
/* UP: Testet, ob alle argcount+1 Argumente unterhalb von args_pointer
 ...
 > argcount: number of arguments-1
 > args_pointer: pointer to the arguments */
local maygc void test_integer_args (uintC argcount, gcv_object_t* args_pointer) { GCTRIGGER(); {
  do {
    {var gcv_object_t* argptr = &NEXT(args_pointer);
    {var object arg = *argptr; /* next argument */
...
/* UP: Converts an object into a float of given type.
 ...
 can trigger GC */
global maygc object coerce_float (object obj, object type) { GCTRIGGER2(obj,type); {
...
/* Converts a function's argument to a C 'double'.
 ...
 can trigger GC */
global maygc double to_double (object x) { GCTRIGGER1(x); {
  double ret;
  x = check_real(x);
...
/* Converts a function's argument to a C 'int'.
 ...
 can trigger GC */
global maygc int to_int (object x) { GCTRIGGER1(x); {
  x = check_integer(x);
  return I_to_L(x);
}}
...
#endif
#if (defined(UNIX)) && (defined(TIME_UNIX))
}
#endif
#line 1736
...
/* Sets the default-long-float length to the value len (>= LF_minlen).
 set_lf_digits(len);
 can trigger GC */
local maygc void set_lf_digits (uintC len) { GCTRIGGER(); {
...
local maygc object log_digits (object x, object digits, gcv_object_t* objptr) { GCTRIGGER2(x,digits); {
