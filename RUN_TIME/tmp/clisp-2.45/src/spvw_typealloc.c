...
/* UP, provides a cons
 ...
 can trigger GC */
global maygc object allocate_cons (void) { GCTRIGGER(); {
...
/* UP: provides a freshly created uninterned symbol with given printname.
 ...
 can trigger GC */
global maygc object make_symbol (object string) { GCTRIGGER1(string); {
...
/* UP, provides vector
 ...
 can trigger GC */
global maygc object allocate_vector (uintL len) { GCTRIGGER(); {
...
/* Function: Allocates a bit/byte vector.
 ...
 can trigger GC */
global maygc object allocate_bit_vector (uintB atype, uintL len) { GCTRIGGER(); {
...
/* UP, provides 8-bit character string
 ...
 can trigger GC */
global maygc object allocate_s8string (uintL len) { GCTRIGGER(); {
...
/* UP, provides immutable 8-bit character string
 ...
 can trigger GC */
global maygc object allocate_imm_s8string (uintL len) { GCTRIGGER(); {
  {var uintL need = size_s8string(len); /* needed memory in bytes */
...
/* UP, provides 16-bit character string
 ...
 can trigger GC */
global maygc object allocate_s16string (uintL len) { GCTRIGGER(); {
...
/* UP, provides immutable 16-bit character string
 ...
 can trigger GC */
global maygc object allocate_imm_s16string (uintL len) { GCTRIGGER(); {
  {var uintL need = size_s16string(len); /* needed memory in bytes */
...
/* UP, provides 32-bit character string
 ...
 can trigger GC */
global maygc object allocate_s32string (uintL len) { GCTRIGGER(); {
...
/* UP, provides immutable 32-bit character string
 ...
 can trigger GC */
global maygc object allocate_imm_s32string (uintL len) { GCTRIGGER(); {
  {var uintL need = size_s32string(len); /* needed memory in bytes */
...
/* UP: Changes the allocation of a Small-String to an Sistring, while
 ...
 can trigger GC */
global maygc object reallocate_small_string (object string, uintB newtype) { GCTRIGGER1(string); {
...
/* UP, provides indirect array
 ...
 can trigger GC */
global maygc object allocate_iarray (uintB flags, uintC rank, tint type) { GCTRIGGER(); {
  {var uintL need = rank;
...
#else
global maygc object allocate_srecord_ (uintW flags_rectype, uintC reclen) { GCTRIGGER(); {
  {var uintL need = size_srecord(reclen);
  allocate(type,true,need,Srecord,ptr,{
...
global maygc object allocate_xrecord_ (uintW flags_rectype, uintC reclen,
                                       uintC recxlen, tint type) { GCTRIGGER(); {
  ASSERT((sintB)(flags_rectype >> (BIG_ENDIAN_P ? 8 : 0)) >= rectype_limit
...
global maygc object allocate_stream (uintB strmflags, uintB strmtype,
                                     uintC reclen, uintC recxlen) { GCTRIGGER(); {
  {var object obj =
...
/* UP, provides foreign-pointer-wrapping
 ...
 can trigger GC */
global maygc object allocate_fpointer (FOREIGN foreign) { GCTRIGGER(); {
...
/* UP, provides handle-wrapping
 ...
 can trigger GC */
global maygc object allocate_handle (Handle handle) { GCTRIGGER(); {
...
/* UP, provides bignum
 ...
 can trigger GC */
global maygc object allocate_bignum (uintC len, sintB sign) { GCTRIGGER(); {
...
/* UP, provides single-float
 ...
 can trigger GC */
global maygc object allocate_ffloat (ffloat value) { GCTRIGGER(); {
...
/* allocate_dfloat(value)
 ...
 can trigger GC */
global maygc object allocate_dfloat (dfloat value) { GCTRIGGER(); {
 #ifdef TYPECODES
  #define SETTFL
 #else
...
/* allocate_dfloat(semhi,mlo)
 ...
 < result: new double-float (LISP-object)
 can trigger GC */
global maygc object allocate_dfloat (uint32 semhi, uint32 mlo) { GCTRIGGER(); {
 #ifdef TYPECODES
  #define SETTFL
 #else
...
/* UP, provides long-float
 ...
 can trigger GC */
global maygc object allocate_lfloat (uintC len, uintL expo, signean sign) { GCTRIGGER(); {
...
/* UP, provides ratio
 ...
 < result: ratio
 can trigger GC */
global maygc object make_ratio (object num, object den) { GCTRIGGER2(num,den); {
...
/* UP, provides complex number
 ...
 can trigger GC */
global maygc object make_complex (object real, object imag) { GCTRIGGER2(real,imag); {
...
/* allocate a thread object
 ...
 can trigger GC */
global maygc object allocate_thread (gcv_object_t *name_) { GCTRIGGER(); {
...
/* allocate a mutex object
 ...
 can trigger GC */
global maygc object allocate_mutex (gcv_object_t *name_) { GCTRIGGER(); {
...
/* allocate an exemption object
 ...
 can trigger GC */
global maygc object allocate_exemption (gcv_object_t *name_) { GCTRIGGER(); {
