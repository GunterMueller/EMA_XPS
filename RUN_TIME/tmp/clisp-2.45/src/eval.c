...
/* UP: dynamically binds the symbols of list symlist
 ...
 changes STACK
 can trigger GC */
global maygc void progv (object symlist, object vallist) { GCTRIGGER2(symlist,vallist); {
  /* check symlist */
  {var uintL llen = 0;
...
global maygc void invoke_handlers (object cond) { GCTRIGGER1(cond); {
...
{ GCTRIGGER6(form,var_env,fun_env,block_env,go_env,decl_env); {
  /* bind Environments: */
  make_ENV5_frame();
...
/* UP: evaluates a form in an empty environment.
 ...
 < mv_count/mv_space: values
 can trigger GC */
global maygc Values eval_noenv (object form) { GCTRIGGER1(form); {
...
local maygc object match_cclosure_key (object closure, uintL argcount,
                                       gcv_object_t* key_args_pointer,
                                       gcv_object_t* rest_args_pointer) { GCTRIGGER1(closure); {
 ...
 *EVALHOOK* and *APPLYHOOK* into consideration.
 ...
 < mv_count/mv_space: values
 can trigger GC */
global maygc Values eval_no_hooks (object form) { GCTRIGGER1(form); {
  {var sp_jmp_buf my_jmp_buf;
  /* build EVAL-Frame: */
  {
    {var gcv_object_t* top_of_frame = STACK; /* Pointer to Frame */
...
/* In EVAL: Applies *APPLYHOOK* to a function (SUBR or Closure) and
 ...
 changes STACK
 can trigger GC */
local maygc Values eval_applyhook(object fun) { GCTRIGGER1(fun); {
...
/* In EVAL: Applies a Foreign-Function to an argument-list,
 ...
 changes STACK
 can trigger GC */
local maygc Values eval_ffunction(object ffun) { GCTRIGGER1(ffun); {
  {var object args = popSTACK(); /* Argument-list */
...
#if defined(byteptr_register)
}
#endif
#if defined(closure_register)
}
#endif
...
/* UP: initialize hand-made compiled closures
 init_cclosures();
 can trigger GC */
global maygc void init_cclosures (void) { GCTRIGGER(); {
