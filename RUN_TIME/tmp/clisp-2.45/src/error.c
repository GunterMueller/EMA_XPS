...
/* finishes the output of an error message and starts a new driver,
 ...
 can trigger GC */
local maygc void end_error (gcv_object_t* stackptr, bool start_driver_p) { GCTRIGGER(); {
...
/* check_classname(obj,type)
 ...
 can trigger GC */
global maygc object check_classname (object obj, object type) { GCTRIGGER2(obj,type); {
...
/* check_fpointer_replacement(obj,restart_p)
 ...
 can trigger GC */
global maygc object check_fpointer_replacement (object obj, bool restart_p) { GCTRIGGER1(obj); {
  for (;;) {
    if (!fpointerp(obj)) {
      pushSTACK(NIL);                /* no PLACE */
      pushSTACK(obj);                /* TYPE-ERROR slot DATUM */
...
/* check_symbol_replacement(obj)
 ...
 can trigger GC */
global maygc object check_symbol_replacement (object obj) { GCTRIGGER1(obj); {
  do {
...
/* UP: make sure that the symbol does not name a global symbol-macro
 return the symbol
 can trigger GC */
global maygc object check_symbol_not_symbol_macro (object symbol) { GCTRIGGER1(symbol); {
...
/* UP: make sure that the symbol does not name a global special variable
 return the symbol
 can trigger GC */
global maygc object check_symbol_not_global_special (object symbol) { GCTRIGGER1(symbol); {
  symbol = check_symbol(symbol);
  if (keywordp(symbol)) {
...
/* check_byte_vector_replacement(obj)
 ...
 can trigger GC */
global maygc object check_byte_vector_replacement (object obj) { GCTRIGGER1(obj); {
  do {
    pushSTACK(NIL);             /* no PLACE */
    pushSTACK(obj);             /* TYPE-ERROR slot DATUM */
...
/* check_pos_integer_replacement(obj)
 ...
 can trigger GC */
global maygc object check_pos_integer_replacement (object obj) { GCTRIGGER1(obj); {
  do {
    pushSTACK(NIL);                /* no PLACE */
    pushSTACK(obj);                /* TYPE-ERROR slot DATUM */
...
/* check_function_replacement(obj)
 ...
 can trigger GC */
global maygc object check_function_replacement (object obj) { GCTRIGGER1(obj); {
  do {
    pushSTACK(NIL); /* no PLACE */
    pushSTACK(obj);         /* TYPE-ERROR slot DATUM */
...
/* check_funname_replacement(obj)
 ...
 can trigger GC */
global maygc object check_funname_replacement (condition_t errtype, object caller, object obj) { GCTRIGGER2(caller,obj); {
