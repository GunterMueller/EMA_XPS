...
local maygc object R_R_norm2_1_R (object x, object y) { GCTRIGGER2(x,y); {
...
local maygc object N_log_abs_R (object z, gcv_object_t *end_p) { GCTRIGGER1(z); {
  if (N_realp(z)) {
    z = N_abs_R(z);
    if (R_zerop(z))
      divide_0();
