...
/* Function: Copies a simple-vector.
 ...
 can trigger GC */
global maygc object copy_svector (object vector) { GCTRIGGER1(vector); {
...
/* Function: Copies a simple-bit/byte-vector.
 ...
 can trigger GC */
global maygc object copy_sbvector (object vector) { GCTRIGGER1(vector); {
...
{ GCTRIGGER1(obj); { /* (cond ((eq obj 'BIT) Atype_Bit)
...
/* Function: Creates a simple-vector with given elements.
 ...
 can trigger GC */
global maygc object vectorof (uintC len) { GCTRIGGER(); {
...
/* Function: Returns the element-type of an array.
 ...
 can trigger GC */
global maygc object array_element_type (object array) { GCTRIGGER1(array); {
...
/* Function: Returns the list of dimensions of an array.
 ...
 can trigger GC */
global maygc object array_dimensions (object array) { GCTRIGGER1(array); {
...
local maygc void elt_copy_32Bit_T (object dv1, uintL index1,
                                   object dv2, uintL index2, uintL count) { GCTRIGGER2(dv1,dv2); {
...
/* Function: Fills a slice of an array with an element.
 ...
 can trigger GC */
global maygc bool elt_fill (object dv, uintL index, uintL count, object element) { GCTRIGGER2(dv,element); {
...
global maygc void elt_reverse (object dv1, uintL index1, object dv2, uintL index2,
                               uintL count) { GCTRIGGER2(dv1,dv2); {
...
/* Function: Allocates a new simple-bit-vector, filled with zeroes.
 ...
 can trigger GC */
global maygc object allocate_bit_vector_0 (uintL len) { GCTRIGGER(); {
...
/* Function: Returns a fresh semi-simple-string of given length, with
 ...
 can trigger GC */
global maygc object make_ssstring (uintL len) { GCTRIGGER(); {
...
/* Function: extend the string to length <= arraysize_limit_1
 ...
 can trigger GC */
local maygc object ssstring_extend_low (object ssstring, uintL size) { GCTRIGGER1(ssstring); {
...
/* Function: Adds a character to a semi-simple-string, thereby possibly
 ...
 can trigger GC */
global maygc object ssstring_push_extend (object ssstring, chart ch) { GCTRIGGER1(ssstring); {
...
/* Function: Ensures that a semi-simple-string has at least a given length,
 ...
 < result: the same semi-simple-string
 can trigger GC */
global maygc object ssstring_extend (object ssstring, uintL needed_len) { GCTRIGGER1(ssstring); {
  {var object sstring = TheIarray(ssstring)->data; /* normal simple string */
...
global maygc object ssstring_append_extend (object ssstring, object srcstring,
                                            uintL start, uintL len) { GCTRIGGER2(ssstring,srcstring); {
...
/* Function: Returns a fresh semi-simple byte-vector of given length, with
 ...
 can trigger GC */
global maygc object make_ssbvector (uintL len) { GCTRIGGER(); {
  if (len > arraysize_limit_1)
    error_dim_type(UL_to_I(len));
...
/* Function: Adds a byte to a semi-simple byte vector, thereby possibly
 ...
 can trigger GC */
global maygc object ssbvector_push_extend (object ssbvector, uintB b) { GCTRIGGER1(ssbvector); {
...
/* auxiliary routine for MAKE-ARRAY and ADJUST-ARRAY:
 ...
 can trigger GC */
local maygc object fill_initial_element (uintL len, object vector) { GCTRIGGER1(vector); {
  if (boundp(STACK_4) /* initial-element supplied? */
      && (len != 0)) { /* and length > 0 ? */
    pushSTACK(vector);
...
/* auxiliary routine for MAKE-ARRAY and ADJUST-ARRAY:
 ...
 can trigger GC */
local maygc object make_storagevector (uintL len, uintB eltype) { GCTRIGGER(); {
  {var object vector;
  switch (eltype) {
...
local maygc object initial_contents (object datenvektor, object dims,
                                     uintL rank, object contents) { GCTRIGGER3(datenvektor,dims,contents); {
...
local maygc void initial_contents_aux (void* arg, object obj) { GCTRIGGER1(obj); {
