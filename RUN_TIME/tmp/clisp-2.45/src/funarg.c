...
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 1),L(eq)))*/;
  return eq(arg2,arg1); }}
global maygc bool call_test_eql (const gcv_object_t* fun,
                                 object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 1),L(eql)))*/;
  return eql(arg2,arg1); }}
global maygc bool call_test_equal (const gcv_object_t* fun,
                                   object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 1),L(equal)))*/;
  return equal(arg2,arg1); }}
global maygc bool call_test_equalp (const gcv_object_t* fun,
                                    object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 1),L(equalp)))*/;
...
global maygc bool call_test_not_eq (const gcv_object_t* fun,
                                    object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 0),L(eq)))*/;
  return !eq(arg2,arg1); }}
global maygc bool call_test_not_eql (const gcv_object_t* fun,
                                     object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 0),L(eql)))*/;
  return !eql(arg2,arg1); }}
global maygc bool call_test_not_equal (const gcv_object_t* fun,
                                       object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 0),L(equal)))*/;
  return !equal(arg2,arg1); }}
global maygc bool call_test_not_equalp (const gcv_object_t* fun,
                                        object arg1, object arg2)
{ GCTRIGGER2(arg1,arg2); { (void)fun/*ASSERT(eq(*(fun STACKop 0),L(equalp)))*/;
  return !equalp(arg2,arg1); }}
