...
/* UP: Stores a character in a string.
 ...
 can trigger GC */
global maygc object sstring_store (object string, uintL index, chart element) { GCTRIGGER1(string); {
...
global maygc object stringof (uintL len) { GCTRIGGER(); {
...
/* UP: Copies a string and thereby turns it into a Simple-String.
 ...
 can trigger GC */
global maygc object copy_string_normal (object string) { GCTRIGGER1(string); {
  {var uintL len;
  {var uintL offset;
...
/* UP: Copies a string and thereby turns it into a Simple-String.
 ...
 can trigger GC */
global maygc object copy_string (object string) { GCTRIGGER1(string); {
  {var uintL len;
  {var uintL offset;
  string = unpack_string_ro(string,&len,&offset);
  {var uintBWL flavour;
...
/* UP: converts a string into a Simple-String.
 ...
 can trigger GC */
global maygc object coerce_ss (object obj) { GCTRIGGER1(obj); {
 start:
 #ifdef TYPECODES
  switch (typecode(obj))
 #else
...
/* UP: return the name of a character
 ...
 can trigger GC */
global maygc object char_name (chart code) { GCTRIGGER(); {
...
/* UP: Checks an optional radix-argument
 ...
 can trigger GC */
local maygc uintWL test_radix_arg (void) { GCTRIGGER(); {
...
/* UP: tests, if all argcount+1 arguments below args_pointer
 ...
 can trigger GC */
local maygc void test_char_args (uintC argcount, gcv_object_t* args_pointer) { GCTRIGGER(); {
  do {
...
/* UP: tests, if all argcount+1 arguments below args_pointer
 ...
 > args_pointer: pointer to the arguments
 can trigger GC */
local maygc void test_char_args_upcase (uintC argcount, gcv_object_t* args_pointer) { GCTRIGGER(); {
  do {
    {var gcv_object_t* argptr = &NEXT(args_pointer);
    {var object arg = *argptr; /* next argument */
    if (!charp(arg)) /* must be a character */
...
/* UP: converts a string piece to opposite case, uppercase characters to
 ...
 can trigger GC */
local maygc void nstring_invertcase (object dv, uintL offset, uintL len) { GCTRIGGER1(dv); {
  restart_it:
  if (len > 0)
    SstringCase(dv,{
      do {
...
/* UP: converts a string to opposite case
 ...
 can trigger GC */
global maygc object string_invertcase (object string) { GCTRIGGER1(string); {
...
/* UP: checks the limits for a string-argument
 ...
 can trigger GC */
global maygc object test_string_limits_ro (stringarg* arg) { GCTRIGGER(); {
...
/* UP: checks the limits for a string-argument
 ...
 increases STACK by 3
 can trigger GC */
local maygc object test_string_limits_rw (stringarg* arg) { GCTRIGGER(); {
...
/* UP: checks a string/symbol/character-argument
 ...
 can trigger GC */
global maygc object test_stringsymchar_arg (object obj, bool invert) { GCTRIGGER1(obj); {
...
local maygc void test_1_stringsym_limits (bool invert, object* string_,
                                          uintL* offset_, uintL* len_) { GCTRIGGER(); {
  {var object string;
  {var uintL len;
  {var uintV start;
  {var uintV end;
...
/* UP: converts the characters of a string piece into uppercase letters
 ...
 > uintL len: number of affected characters
 can trigger GC */
global maygc void nstring_upcase (object dv, uintL offset, uintL len) { GCTRIGGER1(dv); {
 restart_it:
  if (len > 0)
    SstringCase(dv,{
      do {
...
/* UP: converts a string into uppercase letters
 ...
 can trigger GC */
global maygc object string_upcase (object string) { GCTRIGGER1(string); {
  string = copy_string_normal(string); /* copy and turn into a normal-simple-string */
  pushSTACK(string);
...
/* UP: converts the characters of a string piece into lowercase letters
 ...
 > uintL len: number of affected characters
 can trigger GC */
global maygc void nstring_downcase (object dv, uintL offset, uintL len) { GCTRIGGER1(dv); {
 restart_it:
  if (len > 0)
    SstringCase(dv,{
      do {
...
/* UP: converts a string into lowercase letters
 ...
 can trigger GC */
global maygc object string_downcase (object string) { GCTRIGGER1(string); {
  string = copy_string_normal(string); /* copy and turn into a normal-simple-string */
  pushSTACK(string);
...
/* UP: converts the words of a string piece into words, that
 ...
 can trigger GC */
global maygc void nstring_capitalize (object dv, uintL offset, uintL len) { GCTRIGGER1(dv); {
  if (len > 0) {
    {var chart ch;
    SstringCase(dv,{
...
/* UP: Returns a substring of a simple-string.
 ...
 can trigger GC */
global maygc object subsstring (object string, uintL start, uintL end) { GCTRIGGER1(string); {
...
/* UP: concatenates several strings.
 ...
 < STACK: cleaned up
 can trigger GC */
global maygc object string_concat (uintC argcount) { GCTRIGGER(); {
