...
#ifndef COMPILE_STANDALONE
static inline maygc object check_fpointer (object obj, bool restart_p) { GCTRIGGER1(obj); {
...
#ifndef COMPILE_STANDALONE
static inline maygc object check_symbol (object obj) { GCTRIGGER1(obj); {
  if (!symbolp(obj))
...
#ifndef COMPILE_STANDALONE
static inline maygc object check_symbol_non_constant (object obj, object caller) { GCTRIGGER2(obj,caller); {
...
#ifndef COMPILE_STANDALONE
static inline maygc object check_funname (condition_t errtype, object caller, object obj) { GCTRIGGER2(caller,obj); {
  if (!funnamep(obj))
...
#ifndef COMPILE_STANDALONE
static inline maygc object check_structure (object obj) { GCTRIGGER1(obj); {
  if (!structurep(obj))
...
#ifndef COMPILE_STANDALONE
static inline maygc object check_stream (object obj) { GCTRIGGER1(obj); {
  if (!streamp(obj))
...
#ifndef COMPILE_STANDALONE
static inline maygc object check_real (object obj) { GCTRIGGER1(obj); {
...
/* Converts an unsigned longword into an Integer >=0.
 ...
 can trigger GC */
  ...
  #ifdef DEBUG_GCSAFETY
    static inline maygc object UL_to_I (uintL val) { GCTRIGGER(); {
      return fixnum(val);
    }}
  #else
