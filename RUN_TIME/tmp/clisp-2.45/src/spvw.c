...
#if (!(defined(SPVW_MIXED_BLOCKS_OPPOSITE))) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC))) && (!(defined(TYPECODES) && (oint_addr_len+addr_shift > pointer_bitsize)))
}
#endif
#if (!(defined(SPVW_MIXED_BLOCKS_OPPOSITE))) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC))) && (!(defined(TYPECODES) && (oint_addr_len+addr_shift > pointer_bitsize))) && (!(defined(TYPECODES))) && (defined(LINUX_NOEXEC_HEAPCODES))
}
#endif
#if (!(defined(SPVW_MIXED_BLOCKS_OPPOSITE))) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC))) && (!(defined(TYPECODES) && (oint_addr_len+addr_shift > pointer_bitsize))) && (!(defined(TYPECODES))) && (defined(STANDARD_HEAPCODES))
}
#endif
#if (!(defined(SPVW_MIXED_BLOCKS_OPPOSITE))) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC))) && (!(defined(TYPECODES) && (oint_addr_len+addr_shift > pointer_bitsize))) && (defined(TYPECODES))
}
#endif
#if (!(defined(SPVW_MIXED_BLOCKS_OPPOSITE))) && (defined(SUN4_29))
}
#endif
#if (defined(SPVW_MIXED_BLOCKS_OPPOSITE)) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC)))
}
#endif
#if (defined(SPVW_MIXED_BLOCKS_OPPOSITE)) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC))) && (!(defined(TYPECODES)))
}
#endif
#if (defined(SPVW_MIXED_BLOCKS_OPPOSITE)) && (!(defined(SUN4_29))) && (!(defined(UNIX_LINUX) && defined(WIDE_SOFT) && !defined(SPARC))) && (defined(TYPECODES))
}
...
/* run all functions in the list
 can trigger GC */
local void maygc run_hooks (object hooks) { GCTRIGGER1(hooks); {
