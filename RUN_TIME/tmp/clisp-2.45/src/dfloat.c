...
/* Method:
 ...
 e>=53 -> result x */
#ifdef intQsize
local maygc object DF_ftruncate_DF (object x) { GCTRIGGER1(x); {
...
/* method:
 ...
 e>=53 -> result x. */
#ifdef intQsize
local maygc object DF_futruncate_DF (object x) { GCTRIGGER1(x); {
  {var dfloat x_ = TheDfloat(x)->float_value;
  {var uintWL uexp = DF_uexp(x_); /* e + DF_exp_mid */
  if (uexp==0) /* 0.0 ? */
    return x;
...
/* method:
 ...
 e>52 -> result x */
#ifdef intQsize
local maygc object DF_fround_DF (object x) { GCTRIGGER1(x); {
  {var dfloat x_ = TheDfloat(x)->float_value;
  {var uintWL uexp = DF_uexp(x_); /* e + DF_exp_mid */
...
#ifdef intQsize
local maygc object DF_minus_DF (object x) { GCTRIGGER1(x); {
  {var dfloat x_ = TheDfloat(x)->float_value;
  return (DF_uexp(x_) == 0
          ? x
...
/* method (according to [Knuth, II, Seminumerical Algorithms, section 4.2.1., p.200]):
 ...
 Normalize, done. */
#ifdef FAST_DOUBLE
local maygc object DF_DF_plus_DF (object x1, object x2) { GCTRIGGER2(x1,x2); {
...
/* method:
 (- x1 x2) = (+ x1 (- x2)) */
#ifdef FAST_DOUBLE
local maygc object DF_DF_minus_DF (object x1, object x2) { GCTRIGGER2(x1,x2); {
  double_to_DF(DF_to_double(x1) - DF_to_double(x2), return ,
               true, true, /* catch Overflow and subnormal number */
               false, /* no Underflow with result +/- 0.0 possible */
               /* (according to definition of subnormal numbers) */
...
#ifdef FAST_DOUBLE
local maygc object DF_DF_mult_DF (object x1, object x2) { GCTRIGGER2(x1,x2); {
  double_to_DF(DF_to_double(x1) * DF_to_double(x2), return ,
               true, true, /* catch Overflow and subnormal number */
...
local maygc object DF_DF_div_DF (object x1, object x2) { GCTRIGGER2(x1,x2); {
  double_to_DF(DF_to_double(x1) / DF_to_double(x2), return ,
               true, true, /* catch Overflow and subnormal number */
...
local maygc object DF_sqrt_DF (object x) { GCTRIGGER1(x); {
  /* unpack x: */
  {var sintWL exp;
  {var uint64 mantx;
...
#ifdef intQsize
local maygc object DF_to_I (object x) { GCTRIGGER1(x); {
  /* unpack x: */
  {var signean sign;
  {var sintWL exp;
  {var uint64 mant;
...
/* method:
 ...
 exponent:=(integer-length x)
   ...
   On rounding up to 2^53 (rounding overflow) shift mantissa by 1 bit
     to the right and increment exponent. */
local maygc object I_to_DF (object x, bool signal_overflow) { GCTRIGGER1(x); {
  if (eq(x,Fixnum_0))
    return DF_0;
...
local maygc object RA_to_DF (object x, bool signal_overflow) { GCTRIGGER1(x); {
  if (RA_integerp(x))
